...
<template>
  <div class="relative select-none bg-stone-600">
    ...
    <!-- Dropdown menu -->
    <div v-show="isShow" class="z-10 bg-stone-600 divide-y divide-gray-100 rounded-lg shadow-xl w-full absolute top-14">
